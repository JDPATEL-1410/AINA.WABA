...
// CONFIGURATION:
// 1. VITE_API_URL: Use this if Frontend and Backend are on different servers (e.g., Hostinger + Render).
// 2. PROD: If true and VITE_API_URL is missing, assumes same-domain (standard VPS/Node hosting).
// 3. Dev: Defaults to localhost:3000.
const getBaseUrl = () => {
